...
pathlist = ['../results/montepython_mcmc/nulcdm_spec_opt/2022-09-09_100000_' ]
mcmc1 = mcmc(pathlist=pathlist)


## Fishers
# Fisher CF
cf1 = Fisher('../results/cosmicfish_internal/spectroscopic/optimistic/CosmicFish_v1.0_nulcdm_internal_class-Optimistic-own_GCsp_fishermatrix.txt')
