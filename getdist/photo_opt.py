...
pathlist = ['../results/montepython_mcmc/nulcdm_photo_opt/2022-11-30_100000_']
...
gauss2=GaussianND(mean=mp1.fiducials, cov=mp1.fishermatrix,names=mp1.paramnames,labels=mp1.labels,is_inv_cov=True)

## Cosmo Triangle
g = plots.get_subplot_plotter(settings=plot_settings)
g.triangle_plot([mcmc1.samples,gauss1,gauss2],filled=[True,False,False],params=cf1.cosmonames,legend_labels=['MCMC','CF-class','MP-Fish'],contour_lws=[1,2,2])
...
## Nuisance Triangle
g = plots.get_subplot_plotter(settings=plot_settings)
g.triangle_plot([mcmc1.samples,gauss1,gauss2],filled=[True,False,False],params=cf1.nuisancenames,legend_labels=['MCMC','CF-class','MP-Fish'],contour_lws=[1,2,2])
...
g = plots.get_subplot_plotter(settings=plot_settings)
g.rectangle_plot(cf1.cosmonames,cf1.nuisancenames,roots=[mcmc1.samples,gauss1,gauss2],filled=[True,False,False],legend_labels=['MCMC','CF-class','MP-Fish'],contour_lws=[1,2,2])
