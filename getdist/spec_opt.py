...
## Fishers
# Fisher CF
cf1 = Fisher('../results/cosmicfish_internal/spectroscopic/optimistic/CosmicFish_v1.0_nulcdm_internal_class-Optimistic-3PT_GCsp_fishermatrix.txt')

cf2 = Fisher('../results/cosmicfish_internal/spectroscopic/optimistic/CosmicFish_v1.0_nulcdm_internal_camb-Optimistic-3PT_GCsp_fishermatrix.txt')
...
g.triangle_plot([gauss1,gauss2],filled=[False,False],params=cf1.cosmonames,legend_labels=['CF-class','CF-camb'],contour_lws=[2,2])
...
g.triangle_plot([gauss1,gauss2],filled=[False,False],params=cf1.nuisancenames,legend_labels=['CF-class','CF-camb'],contour_lws=[2,2])
...
g.rectangle_plot(cf1.cosmonames,cf1.nuisancenames,roots=[gauss1,gauss2],filled=[False,False],legend_labels=['CF-class','CF-camb'],contour_lws=[2,2])
