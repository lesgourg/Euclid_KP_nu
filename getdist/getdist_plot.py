...
cosmo_pars = ['Omegab','h','ns','sigma8','Omegam','mnu','Neff']
...
'AIA' : 'A_{\mathrm{IA}}', 'etaIA' :'\eta_\mathrm{IA}', 'betaIA' : r'\beta_\mathrm{IA}',
...
'N_eff_camb':'N_{eff}', 'm_nu_camb':r'm_\nu'
}
