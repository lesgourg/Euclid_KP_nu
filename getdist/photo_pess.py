...
#pathlist = ['../results/montepython_mcmc/nulcdm_photo_pess/2022-09-11_100000_','../results/montepython_mcmc/nulcdm_photo_pess/2022-09-10_100000_' ]
#mcmc1 = mcmc(pathlist=pathlist)

## Fishers
# Fisher CF
cf1 = Fisher('../results/cosmicfish_internal/photometric/pessimistic/CosmicFish_v1.0_nulcdm_internal_class-Pessimistic-3PT_WLGCph_fishermatrix.txt')

cf2 = Fisher('../results/cosmicfish_internal/photometric/pessimistic/CosmicFish_v1.0_nulcdm_internal_camb-Pessimistic-3PT_WLGCph_fishermatrix.txt')
