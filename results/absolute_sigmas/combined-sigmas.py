...
################################################ Photo Pess #####################################
paths = {'fisher' : ['../../results/cosmicfish_internal/combined/pess_pess/CosmicFish_v1.0_nulcdm_internal_class-combined-pess-pess_fishermatrix.txt','../../results/cosmicfish_internal/combined/pess_opt/CosmicFish_v1.0_nulcdm_internal_class-combined-pess-opt_fishermatrix.txt','../../results/cosmicfish_internal/combined/opt_pess/CosmicFish_v1.0_nulcdm_internal_class-combined-opt-pess_fishermatrix.txt','../../results/cosmicfish_internal/combined/opt_opt/CosmicFish_v1.0_nulcdm_internal_class-combined-opt-opt_fishermatrix.txt']}
