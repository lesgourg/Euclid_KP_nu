...
B =fm.fisher_matrix(file_name='CosmicFish_v1.0_Camb_Spectro-Opt_3PT_epsmu_0.3_GCsp_fishermatrix.txt')
C =fm.fisher_matrix(file_name='CosmicFish_v1.0_Camb_Spectro-Opt_3PT_epsmu_0.5_GCsp_fishermatrix.txt')
