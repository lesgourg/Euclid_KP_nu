...
A =fm.fisher_matrix(file_name='./CosmicFish_v1.0_Class_P_opt_MN_Halofit_GCphWL_fishermatrix.txt')
B =fm.fisher_matrix(file_name='./CosmicFish_v1.0_Class_P_opt_MN_HMcode_GCphWL_fishermatrix.txt')
