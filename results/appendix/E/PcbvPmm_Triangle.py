...
#CF/CAMB
cf1 = cfm.fisher_matrix(file_name= './CosmicFish_v1.0_Class_P_opt_MN_clustering_GCphWL_fishermatrix.txt')
cf1= cfo.reshuffle(cf1,all_pars)
cf1= cfo.marginalise(cf1, cosmo_pars)

cf2 = cfm.fisher_matrix(file_name='./CosmicFish_v1.0_Class_P_opt_MN_matter_GCphWL_fishermatrix.txt')
...
g.triangle_plot([gauss2,gauss1],filled=[False,False],params= cosmo_pars ,labels=labels,legend_labels=[r'$P_\mathrm{mm}$ prescription',r'$P_\mathrm{cc}$ prescription'],contour_lws=[1,1],colors=colors,    contour_colors=colors)
...
g.export('./plots/less_Pmm_v_Pcb_triangle.pdf')
del g
