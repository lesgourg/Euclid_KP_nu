...
fish_files =  [
    '../../../results/cosmicfish_external/photometric/pessimistic/CosmicFish_v0.9_varying_mnu__external_class-Pessimistic-3PT_HP_WLGCph_fishermatrix.txt',
    '../../../results/cosmicfish_external/photometric/pessimistic/CosmicFish_v0.9_varying_mnu__external_camb-Pessimistic-3PT_HP_WLGCph_fishermatrix.txt'
              ]
