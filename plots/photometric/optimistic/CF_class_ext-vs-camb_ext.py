...
fish_files =  [
    '../../../results/cosmicfish_external/photometric/optimistic/CosmicFish_v0.9_varying_mnu__external_class-Optimistic-3PT_HP_WLGCph_fishermatrix.txt',
    '../../../results/cosmicfish_external/photometric/optimistic/CosmicFish_v0.9_varying_mnu__external_camb-Optimistic-3PT_HP_WLGCph_fishermatrix.txt'
              ]
