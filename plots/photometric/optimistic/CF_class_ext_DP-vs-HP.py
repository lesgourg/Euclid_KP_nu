...
fish_files =  [
    '../../../results/cosmicfish_external/photometric/optimistic/CosmicFish_v1.0_nulcdm_external_class-Optimistic-3PT_DP_WLGCph_fishermatrix.txt',
    '../../../results/cosmicfish_external/photometric/optimistic/CosmicFish_v1.0_nulcdm_external_class-Optimistic-3PT_HP_WLGCph_fishermatrix.txt'
              ]
