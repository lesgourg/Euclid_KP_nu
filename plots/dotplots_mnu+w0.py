...
C= fm.fisher_matrix(file_name='../../Euclid_KP_nu/results/montepython_fisher/photo_opt_mnu+w0/fisher.mat')

fishers_list=[A,B,C]
parstoplot = ['Omegam', 'Omegab', 'h', 'ns', 'sigma8', 'mnu', 'w0', 'b1', 'b2', 'b3', 'b4', 'b5', 'b6', 'b7', 'b8', 'b9', 'b10', 'AIA', 'etaIA']
...
plot_options = {'fishers_list':fishers_list, 
          ...
          'outroot':'Photo_Opt_mnu+w0',  ## file name root for all the plots, extra names can be added individually
...
C= fm.fisher_matrix(file_name='../../Euclid_KP_nu/results/montepython_fisher/photo_pess_mnu+w0/fisher.mat')
...
plot_options = {'fishers_list':fishers_list, 
          ...
          'file_format': '.pdf',   ##file format for all the plots
          'outpath' : './plots/',  ## directory where to store the files, if non-existent, it will be created
          'outroot':'Photo_Pess_mnu+w0',  ## file name root for all the plots, extra names can be added individually
...
C= fm.fisher_matrix(file_name='../../Euclid_KP_nu/results/montepython_fisher/spec_opt_mnu+w0/fisher.mat')

fishers_list=[A,B,C]
parstoplot= ['Omegam','Omegab','h','ns','sigma8','mnu','w0','lnbgs8_1','lnbgs8_2','lnbgs8_3','lnbgs8_4','Ps_1','Ps_2','Ps_3','Ps_4']
fishers_list = [fo.reshuffle(fish,parstoplot) for fish in fishers_list]
...
plot_options = {'fishers_list':fishers_list, 
          ...
          'file_format': '.pdf',   ##file format for all the plots
          'outpath' : './plots/',  ## directory where to store the files, if non-existent, it will be created
          'outroot':'Spectro_Opt_mnu+w0',  ## file name root for all the plots, extra names can be added individually
...
plot_options = {'fishers_list':fishers_list, 
          ...
          'file_format': '.pdf',   ##file format for all the plots
          'outpath' : './plots/',  ## directory where to store the files, if non-existent, it will be created
          'outroot':'Spectro_Pess_mnu+w0',  ## file name root for all the plots, extra names can be added individually
