...
fish_files =  [
    '../../../results/cosmicfish_external/spectroscopic/optimistic/CosmicFish_v0.9_varying_mnu__external_class-Optimistic-own_HP_GCsp_fishermatrix.txt',
    '../../../results/cosmicfish_external/spectroscopic/optimistic/CosmicFish_v0.9_varying_mnu__external_camb-Optimistic-own_HP_GCsp_fishermatrix.txt'
              ]
