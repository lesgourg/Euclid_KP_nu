...
pars= ['Omegab','h','sigma8','mnu']
labels= [r'${\tt MP/MCMC}$',r'${\tt CF/CAMB}$',r'${\tt MP/Fisher}$']
g.triangle_plot([mcmc1.samples,gauss1,gauss2],filled=[True,False,False],params=pars,legend_labels=labels,contour_lws=[1,1,1],colors=colors,    contour_colors=colors)
g.legend.set_title(r'Photometric Optimistic')

g.fig.align_ylabels(axs=None)

g.export('./Validation_Plots/P_MN_validation_dark.png')
