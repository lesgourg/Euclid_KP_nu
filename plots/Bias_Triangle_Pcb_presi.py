...
colors = ['#bc80bd', '#b3de69','#fdb462','#fccde5','#8dd3c7','#ffed6f','#bebada','#80b1d3', '#ccebc5', '#d9d9d9']
...
plt.style.use('plot-style-triangle_dark.txt')
print('exit')
#############################################################
...
#MCMC
pathlist = ['/home/sefa/P_w0waMN_Pcbshift/2023-09-26_100000_']
...
g.triangle_plot([mcmc1.samples,mcmc2.samples],filled=[False,False],params=plot_pars,legend_labels=['Data $P_\mathrm{cc}$ Model $P_\mathrm{mm}$','Data $P_\mathrm{cc}$ Model $P_\mathrm{cc}$'],contour_lws=[1,1],colors=colors,    contour_colors=colors)
...
g.export('./bias_plots/P_MN_Pcb_v_Pmm_bias.png')
