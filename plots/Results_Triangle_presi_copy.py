...
colors = [sns.color_palette('rocket')[ii] for ii in [1,5,3]]
colors = [ '#fdb462','#b3de69','#bc80bd','#fccde5','#8dd3c7','#ffed6f','#bebada','#80b1d3', '#ccebc5', '#d9d9d9']
...
plt.style.use('../../Euclid_KP_nu/plots/plot-style-triangle_dark.txt')
print('exit')
#############################################################

cosmo_pars = ['h','sigma8','ns','mnu','N_ur','Omegam','Omegab','w0','wa']
...
'sigma_v3':'sigmav_3',
'N_ur':'N_ur' ,
'B_E':'B_E','alpha_E':'alpha_E','sigM_0_E':'sigM_0_E','beta_E':'beta_E','gamma_E':'gamma_E','tau_reio':'tau_reio'
}
...
#MCMC
pathlist = ['../../chains/PS_w0waMN_superpessimistic_Santi/2023-07-31_100000_']
mcmc1 = mcmc(pathlist=pathlist)

pathlist = ['/home/sefa/chains/PSC_w0waMN_Ziad/2023-10-04_104000_']
mcmc2 = mcmc(pathlist=pathlist)

pathlist = ['/home/sefa/chains/PSPC_w0waMN_Ziad/2023-09-30_80000_']
mcmc3 = mcmc(pathlist=pathlist)
...
g.triangle_plot([mcmc1.samples,mcmc2.samples,mcmc3.samples],filled=[False,False,False],params=cosmo_pars,legend_labels=[r'${\it Euclid}$',r'${\it Euclid}$+CC',r'${\it Euclid+Planck}$+CC'],contour_lws=[1,1,1],colors=colors, contour_colors=colors)
plt.style.use('../../Euclid_KP_nu/plots/plot-style-triangle_dark.txt')

g.fig.align_ylabels(axs=None)

g.export('./plots/results_cmg.png')
