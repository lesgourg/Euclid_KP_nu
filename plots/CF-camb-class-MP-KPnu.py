...
fish_files =  [
    'sefa/CosmicFish_v1.0_wCDM+mnu+Neff_internal_camb-Optimistic-3PT_WLGCph_fishermatrix.txt',
    'sefa/CosmicFish_v1.0_wCDM+mnu+Neff_internal_class-Optimistic-3PT_WLGCph_fishermatrix.txt'
    ,
    'sefa/MPfisher-WLGCph.mat'
...
nuis=['b1','b2','b3','b4','b5','b6','b7','b8','b9','b10','AIA','etaIA']
...
compare_errors_dict={'legend_title':'WLGCph opt'}
plotter(fish_files=fish_files,labels=labels,pars=cutnames, outfile_name='justMnuNeff_WLGCph',
        error_only=error_only, compare_errors_dict=compare_errors_dict, 
        outpath='./sefa/', cosmo_names=cosmo_names, yrange=[-10, 10],
        marginalise=False)
