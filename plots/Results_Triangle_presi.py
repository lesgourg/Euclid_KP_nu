...
#MCMC
pathlist = ['../../chains/P_w0waMN/2023-07-31_10000_']
mcmc1 = mcmc(pathlist=pathlist)

pathlist = ['../../chains/S_w0waMN/2023-07-28_100000_']
...
g.triangle_plot([mcmc1.samples,mcmc2.samples,mcmc3.samples],filled=[False,False,False],params=cosmo_pars,legend_labels=[r'Photometric',r'Spectroscopic',r'Combined'],contour_lws=[1,1,1],colors=colors, contour_colors=colors)
plt.style.use('../../Euclid_KP_nu/plots/plot-style-triangle.txt')

g.fig.align_ylabels(axs=None)

g.export('./plots/results.png')
